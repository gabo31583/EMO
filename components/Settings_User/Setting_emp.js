...
import Help from './altadeproductos.jpg'
import Metod from './Administrar.jpg'
import cap from './capacitaciones.jpg'
    ...
    return(
        <ScrollView  style = {styles.container}>
            ...
            <TouchableOpacity style = {styles.containerList}>
                ...
                <Text>Dar productos de alta</Text>
            </TouchableOpacity>
            <TouchableOpacity  style = {styles.containerList}>
                <Image source = {Metod} resizeMode='contain' style={styles.image2}/>
                <Text>Administar productos</Text>
            </TouchableOpacity>
            <TouchableOpacity  style = {styles.containerList}>
                <Image source = {cap} resizeMode='contain' style={styles.image2}/>
