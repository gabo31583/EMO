...
render(){
    ...
    return(
        <View  style = {styles.container}>
            ...
            <Text style = {styles.text}>GRACIAS POR TU INTERÉS DE UNIRTE A ESTA COMUNIDAD DE EMPRENDEDORAS, EL ACCESOA LA RED SE TE ENVIARÁ VÍA CORREO ELECTRÓNICO UNA VEZ VALIDADOS TUS DATOS.</Text>
